...
void main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1xdG1jY2FldGxhanJyaGV0bHZpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjAyNzE2NjIsImV4cCI6MjA3NTg0NzY2Mn0.tbo_vztN7rWAXwwSSMI4DGK7WyctdHIi8GM5-5PXOTE',
  );
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF386BF6),
        ),
        useMaterial3: true,
      ),
      initialRoute: '/login',
