...
import 'package:receta_ya/features/profile/domain/usecases/create_profile_usecase.dart';

class UserRepositoryImpl implements UserRepository {
  final AuthDataSource authDataSource = AuthDataSourceImpl();
  final CreateProfileUseCase createProfileUseCase = CreateProfileUseCase();
